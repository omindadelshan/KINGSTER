...
ANKIVECTOR_STICKER = "CAACAgUAAxkBAAJZfmEvjdUpV8AtbT7G71a2QsrHcf3VAAJdAwAC73BJVaYTh4wqEyysIAQ"
...
def AnkiVector_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"* Hi There  The name's {dispatcher.bot.first_name} \n\nAs  You I'm a next generational group management bot developed by Ominda* "
            f"\n\n Join [Update group](https://t.me/sdbotworld) To Keep Yourself Updated About {dispatcher.bot.first_name}"
